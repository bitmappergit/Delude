...
record StateT {a b : Level} (S : Set a) (M : Set a → Set b) (A : Set a) : Set (a ⊔ b) where
...
instance FunctorStateT : {a b : Level}
                       → {S : Set a}
                       → {M : Set a → Set b}
                       → ⦃ _ : Monad M ⦄
                       → Functor (StateT S M)
...
instance ApplicativeStateT : {a b : Level}
                           → {S : Set a}
                           → {M : Set a → Set b}
                           → ⦃ _ : Monad M ⦄
...
instance MonadStateT : {a b : Level}
                     → {S : Set a}
                     → {M : Set a → Set b}
                     → ⦃ _ : Monad M ⦄
                     → Monad (StateT S M)
